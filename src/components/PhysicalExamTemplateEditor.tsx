        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {PREDEFINED_TEMPLATES.sistemas.map((template) => {
            ...
            return (
              <div
                key={template.id}
                className="bg-gradient-to-br from-blue-900/30 to-blue-800/20 border border-blue-700 rounded-lg p-4 hover:border-blue-500 transition-all cursor-pointer hover:scale-105"
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {PREDEFINED_TEMPLATES.especificas.map((template) => {
            ...
            return (
              <div
                key={template.id}
                className="bg-gradient-to-br from-green-900/30 to-green-800/20 border border-green-700 rounded-lg p-4 hover:border-green-500 transition-all cursor-pointer hover:scale-105"
                onClick={() => onSelectTemplate(createTemplateFromPredefined(template))}
              >
                <div className="flex items-center mb-2">
