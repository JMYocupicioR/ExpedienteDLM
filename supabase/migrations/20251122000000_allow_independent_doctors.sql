-- =====================================================
-- MIGRACIÓN: Permitir Médicos Independientes Sin Clínica
-- Fecha: 2025-11-22
-- Descripción: Esta migración permite que médicos independientes
-- (sin clínica asignada) puedan crear y gestionar sus propios
-- pacientes sin requerir autorización de administrador de clínica.
-- =====================================================
...
CREATE INDEX IF NOT EXISTS idx_patients_primary_doctor_independent
