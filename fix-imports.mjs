...
const importMappings = {
  ...
  "'../../components/ActivityFeed'": "'../../components/shared/ActivityFeed'",
  "'@/components/ActivityFeed'": "'@/features/shared/ActivityFeed'",
  ...
  // Correcciones para rutas de lib desde features
  ...
  // Correcciones para hooks dentro de features que buscan useAuth
  "'./useAuth'": "'../authentication/hooks/useAuth'",

  // Correcciones para context dentro de features
  "'../features/clinic/context/ClinicContext'": "'../context/ClinicContext'",
  "'../../features/clinic/context/ClinicContext'": "'../context/ClinicContext'",

  // Correcciones para rutas desde pages/
  "'../../lib/supabase'": "'../lib/supabase'",
  "'../../lib/database.types'": "'../lib/database.types'",
  "'../../lib/medicalConfig'": "'../lib/medicalConfig'",
  "'../../lib/validation'": "'../lib/validation'",
